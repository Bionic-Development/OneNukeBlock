...
public class EarthFangsEntity extends Entity {
    ...
    public EarthFangsEntity(EntityType<? extends EarthFangsEntity> entityType, World world) {
        super(entityType, world);
    }

    public EarthFangsEntity(World world, double x, double y, double z, float yaw, int warmup, LivingEntity owner) {
        this(EntityRegistry.EARTH_FANGS, world);
        this.warmup = warmup;
        this.setOwner(owner);
    ...
    public static EarthFangsEntity create(EntityType<EarthFangsEntity> entityType, World world) {
        return new EarthFangsEntity(entityType, world);
    }
    ...
    public void tick() {
        ...
        if (this.world.isClient) {
            if (this.playingAnimation) {
                ...
                if (this.ticksLeft == 14) {
                    for (int i = 0; i < 12; ++i) {
                        ...
                        this.world.addParticle(new BlockStateParticleEffect(ParticleTypes.BLOCK, Blocks.DIRT.getDefaultState()), d, e + 1.0, f, g, h, j);
                    }
                }
            }
            ...
            if (this.warmup == -8) {
                ...
                this.world.playSound(this.getX(), this.getY(), this.getZ(), SoundEvents.BLOCK_ROOTED_DIRT_BREAK, this.getSoundCategory(), 1.0f, this.random.nextFloat() * 0.2f + 0.85f, false);
    ...
    private void damage(LivingEntity target) {
        ...
        target.damage(DeathDamageSources.EARTHS_FANGS, 10.0f);
    }
