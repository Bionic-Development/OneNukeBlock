...
public class CrazyExGirlfriendEntityRenderer extends MobEntityRenderer<CrazyExGirlfriendEntity, PlayerEntityModel<CrazyExGirlfriendEntity>> {
    private static final Identifier TEXTURE = new Identifier(DeathMoney.MOD_ID, "textures/entity/crazy_ex_girlfriend.png");

    public CrazyExGirlfriendEntityRenderer(EntityRendererFactory.Context context) {
    ...
    public Identifier getTexture(CrazyExGirlfriendEntity crazyExGirlfriendEntity) {
        return TEXTURE;
    }

    @Override
    protected void scale(CrazyExGirlfriendEntity crazyExGirlfriendEntity, MatrixStack matrices, float amount) {
