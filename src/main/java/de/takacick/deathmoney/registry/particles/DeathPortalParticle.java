...
public class DeathPortalParticle extends SpriteBillboardParticle {

    private final double startX;
    private final double startY;
    private final double startZ;

    DeathPortalParticle(ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
    ...
    public static class Factory implements ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            DeathPortalParticle deathPortalParticle = new DeathPortalParticle(clientWorld, d, e, f, g, h, i);
            deathPortalParticle.setSprite(this.spriteProvider);
            return deathPortalParticle;
        }
    }
}
