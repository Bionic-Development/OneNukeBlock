...
public class TerraDrillModel
        extends SinglePartEntityModel<LivingEntity> {

    public static final Identifier TEXTURE = new Identifier(OneElementalBlock.MOD_ID, "textures/entity/terra_drill.png");

    private final ModelPart root;
    private final ModelPart base;
    private final ModelPart drill;

    public TerraDrillModel() {
