...
public class TsunamicWaterFluid extends CustomFluid {

    @Override
    public Fluid getStill() {
        return ItemRegistry.TSUNAMIC_WATER;
    }

    @Override
    public Fluid getFlowing() {
        return ItemRegistry.TSUNAMIC_FLOWING_WATER;
    }
    ...
    public boolean matchesType(Fluid fluid) {
        return fluid == getStill() || fluid == getFlowing() || fluid.isIn(FluidTags.WATER);
    }
    ...
    public static class Flowing extends TsunamicWaterFluid {
        @Override
    ...
    public static class Still extends TsunamicWaterFluid {
        @Override
        public int getLevel(FluidState fluidState) {
            return 8;
        }
