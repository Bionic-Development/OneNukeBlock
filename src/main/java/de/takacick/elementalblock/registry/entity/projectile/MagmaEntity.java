...
public class MagmaEntity extends PersistentProjectileEntity {
    @Nullable
    ...
    public MagmaEntity(World world, double x, double y, double z, @Nullable LivingEntity igniter) {
        this(EntityRegistry.MAGMA, world);
    ...
    public static MagmaEntity create(EntityType<MagmaEntity> entityType, World world) {
        return new MagmaEntity(entityType, world);
    }
    ...
    private void explode() {
        if (!getWorld().isClient) {
            MagmaExplosionHandler.createExplosion((ServerWorld) getWorld(), this, null, null,
