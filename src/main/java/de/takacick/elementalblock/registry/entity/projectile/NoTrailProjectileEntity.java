...
public abstract class NoTrailProjectileEntity
        extends ProjectileEntity {
    public double powerX;
    public double powerY;
    public double powerZ;

    protected NoTrailProjectileEntity(EntityType<? extends NoTrailProjectileEntity> entityType, World world) {
        super(entityType, world);
    }

    public NoTrailProjectileEntity(EntityType<? extends NoTrailProjectileEntity> type, double x, double y, double z, double directionX, double directionY, double directionZ, World world) {
        this(type, world);
    ...
    public NoTrailProjectileEntity(EntityType<? extends NoTrailProjectileEntity> type, LivingEntity owner, double directionX, double directionY, double directionZ, World world) {
