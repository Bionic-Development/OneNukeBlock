...
public class WaterArmorVessel extends Item implements Equipment {

    private final Multimap<EntityAttribute, EntityAttributeModifier> attributeModifiers;

    public WaterArmorVessel(Settings settings) {
        super(settings);
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        ...
        tooltip.add(Text.of("§eProtect yourself in a §bhydro suit §eas"));
        tooltip.add(Text.of("§estrong as steel!"));
