...
public class ColoredGlowSparkParticle extends SpriteBillboardParticle {

    private final SpriteProvider spriteProvider;

    ColoredGlowSparkParticle(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, SpriteProvider spriteProvider) {
    ...
    public record Factory(SpriteProvider spriteProvider)
        ...
        public Particle createParticle(ColoredParticleEffect particleEffect, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            ColoredGlowSparkParticle coloredSparkParticle = new ColoredGlowSparkParticle(clientWorld, d, e, f, g, h, i, this.spriteProvider);
            coloredSparkParticle.setColor(particleEffect.color().x(), particleEffect.color().y(), particleEffect.color().z());
