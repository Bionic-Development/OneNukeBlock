...
public class WaterLeakParticle
        extends SpriteBillboardParticle {
    private final Fluid fluid;
    protected boolean obsidianTear;

    WaterLeakParticle(ClientWorld world, double x, double y, double z, Fluid fluid) {
        super(world, x, y, z);
    ...
    public static class Factory
        ...
        public Particle createParticle(ColoredParticleEffect parameters, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            ContinuousFalling blockLeakParticle = new ContinuousFalling(clientWorld, d, e, f, Fluids.WATER, new ColoredParticleEffect(ParticleRegistry.WATER_SPLASH, parameters.color()));
            blockLeakParticle.setVelocity(g, h, i);
            blockLeakParticle.setSprite(this.spriteProvider);
            blockLeakParticle.setColor(parameters.color().x(), parameters.color().y(), parameters.color().z());
