...
public class WaterPoofParticle
        extends SpriteBillboardParticle {
    private final SpriteProvider spriteProvider;

    protected WaterPoofParticle(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, SpriteProvider spriteProvider) {
        super(world, x, y, z);
        float f;
        ...
        Vector3f color = Vec3d.unpackRgb(0x25A7EA).toVector3f();
        this.red = color.x() * (f = this.random.nextFloat() * 0.1f + 0.9f);
    ...
    public static class Factory
        ...
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            return new WaterPoofParticle(clientWorld, d, e, f, g, h, i, this.spriteProvider);
        }
    }
}
