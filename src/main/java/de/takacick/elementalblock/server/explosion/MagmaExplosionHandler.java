...
public class MagmaExplosionHandler {

    public static final Identifier IDENTIFIER = new Identifier(OneElementalBlock.MOD_ID, "magma_explosion");
    ...
    public MagmaExplosionHandler(double x, double y, double z, float radius, List<BlockPos> affectedBlocks, @Nullable Vec3d playerVelocity) {
        this.x = x;
        this.y = y;
        this.z = z;
        this.radius = radius;
    ...
    public MagmaExplosionHandler(PacketByteBuf buf) {
    ...
    public static void createExplosion(ServerWorld world, @Nullable Entity entity, @Nullable DamageSource damageSource, @Nullable ExplosionBehavior behavior, double x, double y, double z, float power, boolean createFire, net.minecraft.world.explosion.Explosion.DestructionType destructionType) {
        ...
        for (ServerPlayerEntity serverPlayerEntity : world.getPlayers()) {
            ...
            new MagmaExplosionHandler(x, y, z, power, explosion.getAffectedBlocks(), explosion.getAffectedPlayers().get(serverPlayerEntity)).write(packetByteBuf);
    ...
    public static class Explosion extends net.minecraft.world.explosion.Explosion {
        ...
        public void collectBlocksAndDamageEntities() {
            ...
            for (int v = 0; v < list.size(); ++v) {
                ...
                if (this.entity instanceof MagmaEntity magmaEntity && entity.equals(magmaEntity.getOwner())) {
                    continue;
                }
                ...
                entity.damage(this.getDamageSource(), (int) ((ac * ac + ac) / 2.0 * 2.5 * (double) q + 1.0));
                entity.setVelocity(entity.getVelocity().add(x * ad, y * ac, z * ad).add(0, 0.1, 0));
                ...
                this.affectedPlayers.put(playerEntity, new Vec3d(x * ac, y * ac, z * ac).add(0, 0.1, 0));
            }
        }
        ...
        public void affectWorld(boolean particles) {
            ...
            if (this.world.isClient) {
                ...
                this.world.playSound(this.x, this.y, this.z, SoundEvents.BLOCK_FIRE_EXTINGUISH, SoundCategory.BLOCKS, 2f, (1.4f + (this.world.random.nextFloat() - this.world.random.nextFloat()) * 0.2f) * 0.7f, false);
            ...
            if (particles) {
                ...
                for (int i = 0; i < this.power * 25; i++) {

                    double d = random.nextGaussian();
                    double e = random.nextGaussian();
                    double f = random.nextGaussian();

                    this.world.addParticle(ParticleTypes.FLAME, true, this.x + d, this.y + e, this.z + f, d * 2, e * 2, f * 2);
                    this.world.addParticle(ParticleTypes.SMOKE, true, this.x + d, this.y + e, this.z + f, d * 2, e * 2, f * 2);
                }
