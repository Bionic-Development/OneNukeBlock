...
public class PillagerExplosionHandler {

    public static final Identifier IDENTIFIER = new Identifier(EmeraldMoney.MOD_ID, "pillager_explosion");
    ...
    public PillagerExplosionHandler(double x, double y, double z, float radius, List<BlockPos> affectedBlocks, @Nullable Vec3d playerVelocity) {
        this.x = x;
        this.y = y;
        this.z = z;
        this.radius = radius;
    ...
    public PillagerExplosionHandler(PacketByteBuf buf) {
    ...
    public static void createExplosion(ServerWorld world, @Nullable Entity entity, @Nullable DamageSource damageSource, @Nullable ExplosionBehavior behavior, double x, double y, double z, float power, boolean createFire, net.minecraft.world.explosion.Explosion.DestructionType destructionType) {
        ...
        if (destructionType != net.minecraft.world.explosion.Explosion.DestructionType.KEEP) {
            for (ServerPlayerEntity serverPlayerEntity : world.getPlayers()) {
                ...
                new PillagerExplosionHandler(x, y, z, power, explosion.getAffectedBlocks(), explosion.getAffectedPlayers().get(serverPlayerEntity)).write(packetByteBuf);
    ...
    public static class Explosion extends net.minecraft.world.explosion.Explosion {
        ...
        public void collectBlocksAndDamageEntities() {
            ...
            if (this.destructionType.equals(Explosion.DestructionType.KEEP)) {
                return;
            }
        ...
        public void affectWorld(boolean particles) {
            ...
            if (this.world.isClient) {
                this.world.playSound(this.x, this.y, this.z, SoundEvents.ENTITY_PILLAGER_DEATH, SoundCategory.BLOCKS, 3.0f, (1.4f + (this.world.random.nextFloat() - this.world.random.nextFloat()) * 0.2f) * 0.7f, false);
            ...
            if (bl) {
                ...
                int drops = world.getRandom().nextBetween(32, 64);
                ...
                for (int i = 0; i < drops && !this.affectedBlocks.isEmpty(); i++) {
                    ...
                    ItemEntity itemEntity = new ItemEntity(world, pos.getX(), pos.getY(), pos.getZ(), Items.EMERALD.getDefaultStack(), velocity.getX(), velocity.getY(), velocity.getZ());
