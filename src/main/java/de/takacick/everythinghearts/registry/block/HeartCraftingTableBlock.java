...
public class HeartCraftingTableBlock extends Block {

    private static final Text TITLE = Text.translatable("container.heart_crafting");

    public HeartCraftingTableBlock(AbstractBlock.Settings settings) {
        super(settings);
    }
