...
public class AngelDustParticle extends SpriteBillboardParticle {
    private final SpriteProvider spriteProvider;

    protected AngelDustParticle(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, SpriteProvider spriteProvider) {
        super(world, x, y, z);
        ...
        Vec3f vec3f = new Vec3f(Vec3d.unpackRgb(0xFFE6A8));
        float j = this.random.nextFloat() * 0.1f + 0.9f;
        this.red = vec3f.getX() * j;
        this.green = vec3f.getY() * j;
        this.blue = vec3f.getZ() * j;
        this.scale = 0.02f * (this.random.nextFloat() * this.random.nextFloat() * 6.0f + 1.0f);
    ...
    public static class Factory
        ...
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            return new AngelDustParticle(clientWorld, d, e, f, g, h, i, this.spriteProvider);
        }
    }
}
