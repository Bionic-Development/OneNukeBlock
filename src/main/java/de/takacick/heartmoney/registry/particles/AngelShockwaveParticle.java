...
public class AngelShockwaveParticle extends ExplosionLargeParticle {

    public static final List<Vec3f> colors = List.of(new Vec3f(Vec3d.unpackRgb(0xFFE6A8)));
    ...
    protected AngelShockwaveParticle(ClientWorld clientWorld, double d, double e, double f, double g, double h, double i, float distance, int maxAge, float width, SpriteProvider spriteProvider) {
    ...
    public static class Factory
        ...
        public Particle createParticle(ShockwaveParticleEffect particleEffect, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            return new AngelShockwaveParticle(clientWorld, d, e, f, g, h, i, particleEffect.distance(), particleEffect.maxAge(), particleEffect.width(), this.spriteProvider);
        }
    }
}
