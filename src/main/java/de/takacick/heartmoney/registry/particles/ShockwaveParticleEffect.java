...
public record ShockwaveParticleEffect(ParticleType<ShockwaveParticleEffect> particleType, int maxAge, float distance,
    ...
    public String asString() {
        return String.format(Locale.ROOT, "%s %.2f  %2d %.2f", Registry.PARTICLE_TYPE.getId(this.getType()), this.maxAge, Float.valueOf(this.distance), Float.valueOf(this.width));
    }
}
