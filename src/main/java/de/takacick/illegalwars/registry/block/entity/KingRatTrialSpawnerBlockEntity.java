...
public class KingRatTrialSpawnerBlockEntity
        extends BlockEntity
        implements Spawner,
    ...
    public KingRatTrialSpawnerBlockEntity(BlockPos pos, BlockState state) {
        super(EntityRegistry.KING_RAT_TRIAL_SPAWNER, pos, state);
