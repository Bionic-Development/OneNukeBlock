...
import de.takacick.illegalwars.registry.block.entity.model.PieLauncherModel;
...
public class PieLauncherBlockEntityRenderer implements BlockEntityRenderer<PieLauncherBlockEntity> {
    ...
    private static final Identifier BASE = new Identifier(IllegalWars.MOD_ID, "textures/entity/pie_launcher.png");
