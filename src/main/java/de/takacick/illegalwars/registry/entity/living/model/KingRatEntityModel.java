...
public class KingRatEntityModel<T extends WardenEntity>
    ...
    public KingRatEntityModel(ModelPart root) {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData body = root.addChild("body", ModelPartBuilder.create().uv(0, 0).cuboid(-9.0F, -13.0F, -4.0F, 18.0F, 21.0F, 11.0F, new Dilation(0.0F))
                .uv(61, 23).cuboid(-6.0F, -13.0F, -7.0F, 12.0F, 11.0F, 3.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -21.0F, 0.0F));

        ModelPartData body_r1 = body.addChild("body_r1", ModelPartBuilder.create().uv(25, 66).cuboid(-1.0F, 3.1183F, 6.6872F, 2.0F, 2.0F, 10.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 5.0F, 7.0F, 0.2182F, 0.0F, 0.0F));

        ModelPartData body_r2 = body.addChild("body_r2", ModelPartBuilder.create().uv(25, 33).cuboid(-2.0F, -1.9469F, -0.8361F, 4.0F, 4.0F, 10.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 5.0F, 7.0F, -0.3054F, 0.0F, 0.0F));

        ModelPartData head = body.addChild("head", ModelPartBuilder.create().uv(59, 0).cuboid(-4.0F, -6.0F, -8.0F, 8.0F, 6.0F, 13.0F, new Dilation(0.0F))
                .uv(0, 94).cuboid(-1.0F, 0.0F, -8.0F, 2.0F, 3.0F, 0.0F, new Dilation(0.0F))
                .uv(61, 81).cuboid(-6.0F, -9.0F, 2.0F, 3.0F, 5.0F, 2.0F, new Dilation(0.0F))
                .uv(61, 81).mirrored().cuboid(3.0F, -9.0F, 2.0F, 3.0F, 5.0F, 2.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.pivot(0.0F, -13.0F, 0.0F));

        ModelPartData head_r1 = head.addChild("head_r1", ModelPartBuilder.create().uv(50, 66).cuboid(-18.5F, -39.0F, -4.5F, 6.0F, 2.0F, 6.0F, new Dilation(0.0F))
                .uv(19, 81).cuboid(-18.0F, -43.0F, -4.0F, 5.0F, 4.0F, 5.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 34.0F, 0.0F, 0.0F, 0.0F, 0.48F));

        ModelPartData right_arm = body.addChild("right_arm", ModelPartBuilder.create().uv(0, 33).cuboid(-1.0F, 0.0F, -3.0F, 5.0F, 25.0F, 7.0F, new Dilation(0.0F))
                .uv(77, 50).cuboid(-1.5F, -1.0F, -4.0F, 6.0F, 10.0F, 9.0F, new Dilation(0.0F))
                .uv(25, 48).cuboid(-1.0F, 25.0F, -4.0F, 5.0F, 4.0F, 8.0F, new Dilation(0.0F)), ModelTransform.pivot(-13.0F, -13.0F, 1.0F));

        ModelPartData left_arm = body.addChild("left_arm", ModelPartBuilder.create().uv(25, 48).mirrored().cuboid(-4.0F, 25.0F, -4.0F, 5.0F, 4.0F, 8.0F, new Dilation(0.0F)).mirrored(false)
                .uv(0, 33).mirrored().cuboid(-4.0F, 0.0F, -3.0F, 5.0F, 25.0F, 7.0F, new Dilation(0.0F)).mirrored(false)
                .uv(77, 50).mirrored().cuboid(-4.5F, -1.0F, -4.0F, 6.0F, 10.0F, 9.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.pivot(13.0F, -13.0F, 1.0F));

        ModelPartData right_leg = root.addChild("right_leg", ModelPartBuilder.create().uv(0, 66).cuboid(-3.1F, 0.0F, -3.0F, 6.0F, 8.0F, 6.0F, new Dilation(0.0F))
                .uv(0, 81).cuboid(-1.1F, 6.0F, 0.0F, 4.0F, 7.0F, 5.0F, new Dilation(0.0F))
                .uv(40, 81).cuboid(-1.1F, 12.0F, -2.0F, 5.0F, 1.0F, 5.0F, new Dilation(0.0F)), ModelTransform.pivot(-5.9F, -13.0F, 0.0F));

        ModelPartData left_leg = root.addChild("left_leg", ModelPartBuilder.create().uv(0, 66).mirrored().cuboid(-2.9F, 0.0F, -3.0F, 6.0F, 8.0F, 6.0F, new Dilation(0.0F)).mirrored(false)
                .uv(0, 81).mirrored().cuboid(-2.9F, 6.0F, 0.0F, 4.0F, 7.0F, 5.0F, new Dilation(0.0F)).mirrored(false)
                .uv(40, 81).mirrored().cuboid(-3.9F, 12.0F, -2.0F, 5.0F, 1.0F, 5.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.pivot(5.9F, -13.0F, 0.0F));
