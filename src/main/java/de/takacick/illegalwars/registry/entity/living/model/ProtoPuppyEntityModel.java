...
public class ProtoPuppyEntityModel<T extends WolfEntity>
    ...
    public ProtoPuppyEntityModel(ModelPart root) {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData head = modelPartData.addChild("head", ModelPartBuilder.create().uv(0, 13).cuboid(-3.0F, -4.75F, -4.3F + 1.4f, 6.0F, 6.0F, 6.0F, new Dilation(0.0F))
                .uv(18, 57).cuboid(-3.0F, -6.75F, -0.7f + 1.4f, 2.0F, 2.0F, 1.0F, new Dilation(0.0F))
                .uv(18, 53).cuboid(1.0F, -6.75F, -0.7f + 1.4f, 2.0F, 2.0F, 1.0F, new Dilation(0.0F))
                .uv(0, 26).cuboid(-1.5F, -1.7656F, -8.3F + 1.4f, 3.0F, 3.0F, 5.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 11.25F, -8.0F));
        ...
        ModelPartData body = modelPartData.addChild("body", ModelPartBuilder.create().uv(25, 0).cuboid(-3.0F, -0.3F, -3.0F, 6.0F, 6.0F, 6.0F, new Dilation(0.01F))
                .uv(25, 13).cuboid(-2.0F, -2.3F, -3.0F, 4.0F, 2.0F, 5.0F, new Dilation(0.01F))
                .uv(0, 0).cuboid(-3.0F, -8.3F, -3.0F, 6.0F, 6.0F, 6.0F, new Dilation(0.01F)), ModelTransform.of(0.0F, 14.0F, 2.0F, 1.5708F, 0.0F, 0.0F));
