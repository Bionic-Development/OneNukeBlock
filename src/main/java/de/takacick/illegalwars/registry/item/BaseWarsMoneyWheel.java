...
public class BaseWarsMoneyWheel extends BlockItem {

    public BaseWarsMoneyWheel(Block block, Settings settings) {
    ...
    public ActionResult place(ItemPlacementContext context) {
        ...
        List<BlockPos> positions = getPositions(blockPos.add(0, 1, 0), blockState.get(BaseWarsMoneyWheelBlock.FACING));
