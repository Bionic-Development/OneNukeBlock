...
import de.takacick.imagineanything.registry.entity.living.ThanosChadEntity;
...
public class ThanosChadEntityRenderer extends MobEntityRenderer<ThanosChadEntity, PlayerEntityModel<ThanosChadEntity>> {
    private static final Identifier TEXTURE = new Identifier(ImagineAnything.MOD_ID, "textures/entity/thanos_chad.png");

    public ThanosChadEntityRenderer(EntityRendererFactory.Context context) {
    ...
    public Identifier getTexture(ThanosChadEntity thanosChadEntity) {
        return TEXTURE;
    }

    @Override
    protected void scale(ThanosChadEntity thanosChadEntity, MatrixStack matrices, float amount) {
