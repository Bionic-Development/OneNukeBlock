...
public abstract class ThrowProjectileEntity extends ProjectileEntity {
    ...
    static {
        PROJECTILE_FLAGS = DataTracker.registerData(ThrowProjectileEntity.class, TrackedDataHandlerRegistry.BYTE);
        PIERCE_LEVEL = DataTracker.registerData(ThrowProjectileEntity.class, TrackedDataHandlerRegistry.BYTE);
    }
    ...
    protected ThrowProjectileEntity(EntityType<? extends ThrowProjectileEntity> entityType, World world) {
    ...
    protected ThrowProjectileEntity(EntityType<? extends ThrowProjectileEntity> type, double x, double y, double z, World world) {
        this(type, world);
        this.setPosition(x, y, z);
    }

    protected ThrowProjectileEntity(EntityType<? extends ThrowProjectileEntity> type, LivingEntity owner, World world) {
    ...
    public void tick() {
        ...
        if (this.inGround && !bl) {
            ...
            while (!this.isRemoved()) {
                ...
                if (hitResult != null && (!bl || hitResult.getType().equals(HitResult.Type.ENTITY))) {
    ...
    protected void onEntityHit(EntityHitResult entityHitResult) {
        ...
        if (entity2 == null) {
            damageSource2 = DamageSource.thrownProjectile(this, this);
        } else {
            damageSource2 = DamageSource.thrownProjectile(this, entity2);
