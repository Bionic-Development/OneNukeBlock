...
public class ImaginedIronMan extends Item implements Imagined {
    private final List<Direction> directionList = new ArrayList<>();

    public ImaginedIronMan(Settings settings) {
        super(settings);
    ...
    public void spawnStructure(PlayerEntity player, World world, BlockPos blockPos) {
        ...
        try {
            File file = File.createTempFile("src/main/resources/data/imagineanything/schematics/" + "imagined_iron_man", "file");
            FileUtils.copyInputStreamToFile(ImagineAnything.class.getClassLoader().getResourceAsStream("data/imagineanything/schematics/" + "imagined_iron_man" + ".schematic"), file);
    ...
    public Identifier getTexture() {
        return new Identifier(ImagineAnything.MOD_ID, "textures/item/imagined_iron_man.png");
    }
}