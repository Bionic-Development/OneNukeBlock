...
public class GlowSparkParticle extends SpriteBillboardParticle {
    ...
    GlowSparkParticle(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, SpriteProvider spriteProvider) {
    ...
    public record Factory(SpriteProvider spriteProvider)
        ...
        public Particle createParticle(ColoredGlowParticleEffect particleEffect, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            GlowSparkParticle glowTotemParticle = new GlowSparkParticle(clientWorld, d, e, f, g, h, i, this.spriteProvider);
