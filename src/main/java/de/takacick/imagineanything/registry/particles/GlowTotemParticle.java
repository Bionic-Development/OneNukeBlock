...
public class GlowTotemParticle extends AnimatedParticle {

    GlowTotemParticle(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, SpriteProvider spriteProvider) {
    ...
    public record Factory(SpriteProvider spriteProvider)
            implements ParticleFactory<ColoredGlowParticleEffect> {

        @Override
        public Particle createParticle(ColoredGlowParticleEffect particleEffect, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            GlowTotemParticle glowTotemParticle = new GlowTotemParticle(clientWorld, d, e, f, g, h, i, this.spriteProvider);
            glowTotemParticle.setColor(particleEffect.color().getX(), particleEffect.color().getY(), particleEffect.color().getZ());
            return glowTotemParticle;
        }
    }
}
