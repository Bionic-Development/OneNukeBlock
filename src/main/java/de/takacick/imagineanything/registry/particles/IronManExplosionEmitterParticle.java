...
public class IronManExplosionEmitterParticle extends NoRenderParticle {
    private int age_;
    private final int maxAge_;

    IronManExplosionEmitterParticle(ClientWorld clientWorld, double d, double e, double f) {
    ...
    public void tick() {
        for (int i = 0; i < 6; ++i) {
            ...
            this.world.addParticle(ParticleRegistry.IRON_MAN_EXPLOSION, d, e, f, (float) this.age_ / (float) this.maxAge_, 0.0, 0.0);
        }
        ++this.age_;
    ...
    public static class Factory
        ...
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            return new IronManExplosionEmitterParticle(clientWorld, d, e, f);
        }
    }
}