...
public class TelekinesisExplosionParticle extends SpriteBillboardParticle {
    ...
    TelekinesisExplosionParticle(ClientWorld clientWorld, double d, double e, double f, double g, SpriteProvider spriteProvider) {
    ...
    public static class Factory
        ...
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            return new TelekinesisExplosionParticle(clientWorld, d, e, f, g, this.spriteProvider);
        }
    }
}