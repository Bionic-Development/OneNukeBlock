package de.takacick.immortalmobs.client;
...
public class CustomLayers {
    ...
    public static Shader IMMORTAL_SHADER;
    private static final RenderPhase.Shader IMMORTAL_RENDER_PHASE = new RenderPhase.Shader(() -> IMMORTAL_SHADER);

    public static final Function<Identifier, RenderLayer> IMMORTAL_CUTOUT = Util.memoize((texture) -> {
        net.minecraft.client.render.RenderLayer.MultiPhaseParameters multiPhaseParameters = net.minecraft.client.render.RenderLayer.MultiPhaseParameters.builder().shader(IMMORTAL_RENDER_PHASE)
                .texture(CustomTextures.create()
                        ...
                        .add(texture, false, false)
                        .build())
                .transparency(net.minecraft.client.render.RenderLayer.NO_TRANSPARENCY)
                .lightmap(net.minecraft.client.render.RenderLayer.ENABLE_LIGHTMAP)
                .cull(RenderPhase.DISABLE_CULLING)
                .overlay(RenderPhase.Overlay.ENABLE_OVERLAY_COLOR).build(false);
        return net.minecraft.client.render.RenderLayer.of("immortal_cutout", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL,
                VertexFormat.DrawMode.QUADS, 256, true, false, multiPhaseParameters);
    });

    public static final BiFunction<Identifier, Identifier, RenderLayer> IMMORTAL_CUTOUT_MIPPED = Util.memoize((texture, texture2) -> {
        net.minecraft.client.render.RenderLayer.MultiPhaseParameters multiPhaseParameters = net.minecraft.client.render.RenderLayer.MultiPhaseParameters.builder().shader(IMMORTAL_RENDER_PHASE)
                .texture(CustomTextures.create()
                        .add(texture, false, false)
                        .add(EndPortalBlockEntityRenderer.SKY_TEXTURE, false, false)
    ...
    public static class CustomTextures
        ...
        public static CustomTextures.Builder create() {
            return new CustomTextures.Builder();
        }
        ...
        public static final class Builder {
            ...
            public CustomTextures.Builder add(Identifier id, boolean blur, boolean mipmap) {
