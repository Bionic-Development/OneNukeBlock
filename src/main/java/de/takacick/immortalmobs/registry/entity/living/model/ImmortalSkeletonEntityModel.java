...
public class ImmortalSkeletonEntityModel<T extends MobEntity>
        extends BipedEntityModel<T> {
    public ImmortalSkeletonEntityModel(ModelPart modelPart) {
        super(modelPart);
    }
    ...
    public static TexturedModelData getOuterTexturedModelData() {
        ...
        modelPartData.getChild("body")
                .addChild("heart", ModelPartBuilder.create().uv(49, 18).cuboid(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new Dilation(0.21F)), ModelTransform.pivot(0.0F, 5.0F, 0.0F));

        modelPartData.addChild(EntityModelPartNames.RIGHT_ARM, ModelPartBuilder.create().uv(40, 16).cuboid(-1.0f, -2.0f, -1.0f, 2.0f, 12.0f, 2.0f, new Dilation(0.1F)), ModelTransform.pivot(-5.0f, 2.0f, 0.0f));
        modelPartData.addChild(EntityModelPartNames.LEFT_ARM, ModelPartBuilder.create().uv(40, 16).mirrored().cuboid(-1.0f, -2.0f, -1.0f, 2.0f, 12.0f, 2.0f, new Dilation(0.1F)), ModelTransform.pivot(5.0f, 2.0f, 0.0f));
        modelPartData.addChild(EntityModelPartNames.RIGHT_LEG, ModelPartBuilder.create().uv(0, 16).cuboid(-1.0f, 0.0f, -1.0f, 2.0f, 12.0f, 2.0f, new Dilation(0.1F)), ModelTransform.pivot(-2.0f, 12.0f, 0.0f));
        modelPartData.addChild(EntityModelPartNames.LEFT_LEG, ModelPartBuilder.create().uv(0, 16).mirrored().cuboid(-1.0f, 0.0f, -1.0f, 2.0f, 12.0f, 2.0f, new Dilation(0.1F)), ModelTransform.pivot(2.0f, 12.0f, 0.0f));
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        modelPartData.getChild("body")
                .addChild("heart", ModelPartBuilder.create().uv(35, 4).cuboid(-1.5F, -1.5F, -1.5F, 3.0F, 3.0F, 3.0F, new Dilation(0.0F)), ModelTransform.pivot(-0.025F, 4.5F, 0.0F));
