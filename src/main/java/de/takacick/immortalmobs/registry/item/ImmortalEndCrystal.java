...
public class ImmortalEndCrystal extends Item implements ImmortalItem {

    public ImmortalEndCrystal(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (world instanceof ServerWorld) {
            ImmortalEndCrystalEntity immortalEndCrystalEntity = new ImmortalEndCrystalEntity(world, d + 0.5, e, f + 0.5);
            world.spawnEntity(immortalEndCrystalEntity);
