...
public class ImmortalGlowTotemParticle extends AnimatedParticle {

    ImmortalGlowTotemParticle(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, SpriteProvider spriteProvider) {
        ...
        setColor(0.4029412f, 0.14705883f, 0.5411765f);
    }
    ...
    public record Factory(SpriteProvider spriteProvider)
        ...
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            return new ImmortalGlowTotemParticle(clientWorld, d, e, f, g, h, i, this.spriteProvider);
        }
    }
}
