...
public class ImmortalTotemParticle extends AnimatedParticle {

    ImmortalTotemParticle(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, SpriteProvider spriteProvider) {
    ...
    public record Factory(SpriteProvider spriteProvider)
        ...
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            return new ImmortalTotemParticle(clientWorld, d, e, f, g, h, i, this.spriteProvider);
        }
    }
}
