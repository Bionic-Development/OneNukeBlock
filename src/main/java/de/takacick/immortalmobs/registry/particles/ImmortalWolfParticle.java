...
public class ImmortalWolfParticle extends ExplosionLargeParticle {
    private float height = 0f;

    protected ImmortalWolfParticle(ClientWorld clientWorld, double d, double e, double f, double g, float height, SpriteProvider spriteProvider) {
    ...
    public static class Factory
            implements ParticleFactory<ImmortalWolfParticleEffect> {
        ...
        @Override
        public Particle createParticle(ImmortalWolfParticleEffect particleEffect, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {

            ImmortalWolfParticle immortalWolfParticle = new ImmortalWolfParticle(clientWorld, d, e, f, g, particleEffect.height(), this.spriteProvider);
            immortalWolfParticle.setColor(particleEffect.color().getX(), particleEffect.color().getY(), particleEffect.color().getZ());
            return immortalWolfParticle;
        }
    }
}
