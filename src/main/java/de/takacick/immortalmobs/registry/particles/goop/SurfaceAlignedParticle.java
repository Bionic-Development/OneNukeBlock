            ...
            for (int x = 1; x < (int) ts + 1; x++, vi++) {
                ...
                if (render) {
                    ...
                    if (new Vec3f(red, green, blue).equals(new Vec3f(0.80f, 0.80f, 0.80f))) {
                        ...
                        vertexConsumer.vertex(modVerts[0].getX(), modVerts[0].getY(), modVerts[0].getZ()).color(this.red, this.green, this.blue, this.alpha).texture(uvs.get(vi).x, uvs.get(vi).y).overlay(OverlayTexture.DEFAULT_UV).light(n).normal(0, 0, 0).next();
                        vertexConsumer.vertex(modVerts[1].getX(), modVerts[1].getY(), modVerts[1].getZ()).color(this.red, this.green, this.blue, this.alpha).texture(uvs.get((int) (vi + ts + 1)).x, uvs.get((int) (vi + ts + 1)).y).overlay(OverlayTexture.DEFAULT_UV).light(n).normal(0, 0, 0).next();
                        vertexConsumer.vertex(modVerts[2].getX(), modVerts[2].getY(), modVerts[2].getZ()).color(this.red, this.green, this.blue, this.alpha).texture(uvs.get((int) (vi + ts + 2)).x, uvs.get((int) (vi + ts + 2)).y).overlay(OverlayTexture.DEFAULT_UV).light(n).normal(0, 0, 0).next();
                        vertexConsumer.vertex(modVerts[3].getX(), modVerts[3].getY(), modVerts[3].getZ()).color(this.red, this.green, this.blue, this.alpha).texture(uvs.get(vi + 1).x, uvs.get(vi + 1).y).overlay(OverlayTexture.DEFAULT_UV).light(n).normal(0, 0, 0).next();
                        //bottom
                        vertexConsumer.vertex(modVerts[3].getX(), modVerts[3].getY(), modVerts[3].getZ()).color(this.red, this.green, this.blue, this.alpha).texture(uvs.get(vi + 1).x, uvs.get(vi + 1).y).overlay(OverlayTexture.DEFAULT_UV).light(n).normal(0, 0, 0).next();
                        vertexConsumer.vertex(modVerts[2].getX(), modVerts[2].getY(), modVerts[2].getZ()).color(this.red, this.green, this.blue, this.alpha).texture(uvs.get((int) (vi + ts + 2)).x, uvs.get((int) (vi + ts + 2)).y).overlay(OverlayTexture.DEFAULT_UV).light(n).normal(0, 0, 0).next();
                        vertexConsumer.vertex(modVerts[1].getX(), modVerts[1].getY(), modVerts[1].getZ()).color(this.red, this.green, this.blue, this.alpha).texture(uvs.get((int) (vi + ts + 1)).x, uvs.get((int) (vi + ts + 1)).y).overlay(OverlayTexture.DEFAULT_UV).light(n).normal(0, 0, 0).next();
