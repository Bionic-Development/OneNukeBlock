...
public class SuperbrineExplosionHandler {

    public static final Identifier IDENTIFIER = new Identifier(OneDeathBlock.MOD_ID, "superbrine_explosion");
    ...
    public SuperbrineExplosionHandler(double x, double y, double z, float radius, List<BlockPos> affectedBlocks, @Nullable Vec3d playerVelocity) {
        this.x = x;
        this.y = y;
        this.z = z;
        this.radius = radius;
    ...
    public SuperbrineExplosionHandler(PacketByteBuf buf) {
    ...
    public static void createExplosion(ServerWorld world, @Nullable Entity entity, @Nullable DamageSource damageSource, @Nullable ExplosionBehavior behavior, double x, double y, double z, float power, boolean createFire, net.minecraft.world.explosion.Explosion.DestructionType destructionType) {
        ...
        for (ServerPlayerEntity serverPlayerEntity : world.getPlayers()) {
            ...
            new SuperbrineExplosionHandler(x, y, z, power, explosion.getAffectedBlocks(), explosion.getAffectedPlayers().get(serverPlayerEntity)).write(packetByteBuf);
        ...
        public void collectBlocksAndDamageEntities() {
            ...
            for (int v = 0; v < list.size(); ++v) {
                ...
                if (entity instanceof PlayerProperties playerProperties) {
                    ...
                    playerProperties.addDeaths(world.getRandom().nextBetween(500, 1000), true);
                } else {
