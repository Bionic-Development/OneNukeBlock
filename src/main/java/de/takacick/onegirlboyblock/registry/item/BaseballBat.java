...
public class BaseballBat extends SwordItem implements HandheldItem {

    public static ToolMaterial BASEBALL_BAT_MATERIAL = new BaseballBatToolMaterial();

    public BaseballBat(Settings settings) {
        super(BASEBALL_BAT_MATERIAL, settings);
    }
    ...
    public boolean postHit(ItemStack stack, LivingEntity target, LivingEntity attacker) {
        ...
        EventHandler.sendEntityStatus(target.getWorld(), target, OneGirlBoyBlock.IDENTIFIER, 1, 0);
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
        tooltip.add(Text.literal("Make every swing a §ehome run§r!").withColor(0x0066FF));
    ...
    public static class BaseballBatToolMaterial implements ToolMaterial {
