...
public class SugarParticle
    ...
    private static final Item ITEM = Items.SUGAR;
    private final BakedModel bakedModel;

    protected SugarParticle(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
        super(world, x, y, z);
    ...
    public static class Factory
        ...
        public Particle createParticle(SimpleParticleType parameters, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            return new SugarParticle(clientWorld, d, e, f, g, h, i);
        }
    }
}
