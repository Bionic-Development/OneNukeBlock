...
public class FollowLoveGoal
extends Goal {
    protected final SimpEntity mob;
    ...
    public FollowLoveGoal(SimpEntity mob, double speed, boolean pauseWhenMobIdle) {
        this.mob = mob;
        this.speed = speed;
    ...
    public void tick() {
        ...
        this.mob.dropItem(livingEntity);
