...
public class ZukoHumanoidEntityModel<T extends WardenEntity>
    ...
    public ZukoHumanoidEntityModel(ModelPart root) {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData body = root.addChild("body", ModelPartBuilder.create().uv(0, 0).cuboid(-9.0F, -13.0F, -6.0F, 18.0F, 21.0F, 15.0F, new Dilation(0.0F))
                .uv(51, 21).cuboid(-2.0F, 2.0F, 9.0F, 4.0F, 4.0F, 16.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -21.0F, 0.0F));

        ModelPartData body_r1 = body.addChild("body_r1", ModelPartBuilder.create().uv(0, 0).cuboid(-3.0F, 0.5F, 0.25F, 6.0F, 6.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -13.0F, -6.0F, -0.3927F, 0.0F, 0.0F));

        ModelPartData head = body.addChild("head", ModelPartBuilder.create().uv(0, 37).cuboid(-8.0F, -12.0F, -5.0F, 16.0F, 12.0F, 12.0F, new Dilation(0.0F))
                .uv(0, 7).cuboid(8.0F, -3.0F, -5.0F, 5.0F, 3.0F, 0.0F, new Dilation(0.0F))
                .uv(76, 20).cuboid(5.0F, -17.0F, 1.0F, 3.0F, 5.0F, 6.0F, new Dilation(0.0F))
                .uv(0, 7).mirrored().cuboid(-13.0F, -3.0F, -5.0F, 5.0F, 3.0F, 0.0F, new Dilation(0.0F)).mirrored(false)
                .uv(76, 20).mirrored().cuboid(-8.0F, -17.0F, 1.0F, 3.0F, 5.0F, 6.0F, new Dilation(0.0F)).mirrored(false)
                .uv(25, 62).cuboid(-4.0F, -4.0F, -8.0F, 8.0F, 4.0F, 3.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -13.0F, 0.0F));

        ModelPartData right_arm = body.addChild("right_arm", ModelPartBuilder.create().uv(0, 62).cuboid(-4.0F, 0.0F, -4.0F, 8.0F, 22.0F, 8.0F, new Dilation(0.0F)), ModelTransform.pivot(-13.0F, -13.0F, 1.0F));

        ModelPartData left_arm = body.addChild("left_arm", ModelPartBuilder.create().uv(49, 54).cuboid(-4.0F, 0.0F, -4.0F, 8.0F, 22.0F, 8.0F, new Dilation(0.0F)), ModelTransform.pivot(13.0F, -13.0F, 1.0F));

        ModelPartData right_leg = root.addChild("right_leg", ModelPartBuilder.create().uv(74, 42).cuboid(-3.1F, 0.0F, -3.0F, 6.0F, 13.0F, 6.0F, new Dilation(0.0F)), ModelTransform.pivot(-5.9F, -13.0F, 0.0F));

        ModelPartData left_leg = root.addChild("left_leg", ModelPartBuilder.create().uv(67, 0).cuboid(-2.9F, 0.0F, -3.0F, 6.0F, 13.0F, 6.0F, new Dilation(0.0F)), ModelTransform.pivot(5.9F, -13.0F, 0.0F));
