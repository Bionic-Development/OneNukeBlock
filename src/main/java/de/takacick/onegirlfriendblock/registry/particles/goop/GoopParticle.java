package de.takacick.onegirlfriendblock.registry.particles.goop;
...
public class GoopParticle extends SurfaceAlignedParticle {
    ...
    protected GoopParticle(ClientWorld world, double x, double y, double z, SpriteProvider spriteProvider, Vector3f color, float scale, Vec3d dir) {
    ...
    public void tick() {
        ...
        if (dir.y() < 0 && random.nextInt(120) == 0)
