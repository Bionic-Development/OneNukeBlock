...
public class SpotlightRenderUtils {
    ...
    public static final Identifier SPOTLIGHT_TEXTURE = Identifier.of(OneNukeBlock.MOD_ID, "textures/entity/light.png");

    public static void renderSpotlight(MatrixStack matrices, VertexConsumer vertices, float red, float green, float blue, float alpha, float yOffset, float height, float x1, float z1, float x2, float z2, float x3, float z3, float x4, float z4, float u1, float u2, float v1, float v2) {
    ...
    private static void renderFace(MatrixStack.Entry entry, VertexConsumer vertices, float red, float green, float blue, float alpha, float yOffset, float height, float x1, float z1, float x2, float z2, float u1, float u2, float v1, float v2) {
        renderVertex(entry, vertices, red, green, blue, 0.0f, height, x1 * 2, z1 * 2, u2, v1);
        ...
        renderVertex(entry, vertices, red, green, blue, 0.0f, height, x2 * 2, z2 * 2, u1, v1);
