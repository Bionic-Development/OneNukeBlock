...
import de.takacick.onenukeblock.registry.entity.living.ai.goal.CreeperIgniteGoal;
...
public class CreeperScientistEntity extends HostileEntity implements SkinOverlayOwner {
    ...
    public CreeperScientistEntity(EntityType<? extends CreeperScientistEntity> entityType, World world) {
    ...
    protected void dropEquipment(ServerWorld world, DamageSource source, boolean causedByPlayer) {
        ...
        if (entity != this && entity instanceof CreeperScientistEntity creeperEntity) {
    ...
    public final void spawnEffectsCloud() {
        Collection<StatusEffectInstance> collection = List.of(new StatusEffectInstance(StatusEffects.POISON, 400, 0));
    ...
    static {
        FUSE_SPEED = DataTracker.registerData(CreeperScientistEntity.class, TrackedDataHandlerRegistry.INTEGER);
        CHARGED = DataTracker.registerData(CreeperScientistEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
        IGNITED = DataTracker.registerData(CreeperScientistEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    }
}