...
public class ProtoEntityModel<T extends WolfEntity>
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData head = modelPartData.addChild("head", ModelPartBuilder.create().uv(0, 13).cuboid(-3.0F, -4.75F, -4.3F, 6.0F, 6.0F, 6.0F, new Dilation(0.0F))
                .uv(49, 37).cuboid(-3.0F, -4.75F, -5.3F, 6.0F, 3.0F, 1.0F, new Dilation(0.0F))
                .uv(28, 58).cuboid(-1.5F, -7.75F, -3.8F, 3.0F, 3.0F, 3.0F, new Dilation(0.0F))
        ...
        ModelPartData tail = modelPartData.addChild("tail", ModelPartBuilder.create().uv(0, 53).cuboid(-1.0F, 0.0F, -1.0F, 2.0F, 2.0F, 2.0F, new Dilation(0.0F))
                .uv(50, 37).cuboid(0.0F, 2.0F, -5.0F, 0.0F, 9.0F, 7.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 12.0F, 9.7F, 1.5708F, 0.0F, 0.0F));

        ModelPartData body = modelPartData.addChild("body", ModelPartBuilder.create().uv(25, 0).cuboid(-3.0F, 1.7F, -3.0F, 6.0F, 6.0F, 6.0F, new Dilation(0.0F))
                .uv(25, 13).cuboid(-2.0F, -2.3F, -3.0F, 4.0F, 4.0F, 5.0F, new Dilation(0.0F))
                .uv(51, 13).cuboid(1.0F, -7.3F, 2.0F, 0.0F, 6.0F, 3.0F, new Dilation(0.0F))
        ...
        ModelPartData right_hind_leg = modelPartData.addChild("right_hind_leg", ModelPartBuilder.create().uv(18, 44).cuboid(0.0F, 2.0F, -2.3F, 2.0F, 6.0F, 2.0F, new Dilation(0.0F))
                .uv(0, 35).cuboid(0.0F, -1.0F, -2.3F, 2.0F, 3.0F, 3.0F, new Dilation(0.0F)), ModelTransform.pivot(-3.5F, 16.0F, 10.1F));
        ...
        ModelPartData left_hind_leg = modelPartData.addChild("left_hind_leg", ModelPartBuilder.create().uv(33, 35).cuboid(0.0F, 2.0F, -2.3F, 2.0F, 6.0F, 2.0F, new Dilation(0.0F))
                .uv(22, 35).cuboid(0.0F, -1.0F, -2.3F, 2.0F, 3.0F, 3.0F, new Dilation(0.0F)), ModelTransform.pivot(1.5F, 16.0F, 10.1F));
