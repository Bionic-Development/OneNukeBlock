...
public class BangMaceExplosionPacket implements CustomPayload {
    public static final Id<BangMaceExplosionPacket> PACKET_ID = new Id<>(Identifier.of(OneNukeBlock.MOD_ID, "bang_mace_explosion"));
    public static final PacketCodec<RegistryByteBuf, BangMaceExplosionPacket> PACKET_CODEC = PacketCodec.of(BangMaceExplosionPacket::write, BangMaceExplosionPacket::new);
    ...
    public BangMaceExplosionPacket(double x, double y, double z, float radius, List<BlockPos> affectedBlocks, @Nullable Vec3d playerVelocity, Explosion.DestructionType destructionType, ParticleEffect particle, ParticleEffect emitterParticle, RegistryEntry<SoundEvent> registryEntry) {
        this.x = x;
        this.y = y;
        this.z = z;
        this.radius = radius;
    ...
    private BangMaceExplosionPacket(RegistryByteBuf buf) {
