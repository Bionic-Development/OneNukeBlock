package de.takacick.onenukeblock.utils.oneblock.server;

import com.mojang.brigadier.CommandDispatcher;
import com.mojang.brigadier.tree.LiteralCommandNode;
import de.takacick.onenukeblock.utils.nuketimer.NukeTimerCommand;
import de.takacick.onenukeblock.utils.oneblock.OneBlock;
import de.takacick.onenukeblock.utils.oneblock.screen.DropsScreenHandler;
...
public class OneBlockCommand {
    ...
    public static void register(String alias, Block block, int color, CommandDispatcher<ServerCommandSource> dispatcher, CommandRegistryAccess registryAccess, Function<MinecraftServer, Optional<OneBlock>> oneBlockGetter) {
        ...
        NukeTimerCommand.register(rootNode);
