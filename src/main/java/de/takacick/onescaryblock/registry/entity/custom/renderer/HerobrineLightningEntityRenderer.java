...
public class HerobrineLightningEntityRenderer
        extends EntityRenderer<LightningEntity> {

    public static int LIGHTNING_COLOR_HEX = 0x820A0A;
    public static Vector3f LIGHTNING_COLOR = Vec3d.unpackRgb(LIGHTNING_COLOR_HEX).toVector3f();

    public HerobrineLightningEntityRenderer(EntityRendererFactory.Context context) {
        super(context);
    }
        ...
        for (int l = 0; l < 4; ++l) {
            ...
            for (int m = 0; m < 3; ++m) {
                ...
                for (int r = n; r >= o; --r) {
                    ...
                    HerobrineLightningEntityRenderer.drawBranch(matrix4f, vertexConsumer, p, q, r, s, t, LIGHTNING_COLOR.x(), LIGHTNING_COLOR.y(), LIGHTNING_COLOR.z(), y, z, false, false, true, false);
                    HerobrineLightningEntityRenderer.drawBranch(matrix4f, vertexConsumer, p, q, r, s, t, LIGHTNING_COLOR.x(), LIGHTNING_COLOR.y(), LIGHTNING_COLOR.z(), y, z, true, false, true, true);
                    HerobrineLightningEntityRenderer.drawBranch(matrix4f, vertexConsumer, p, q, r, s, t, LIGHTNING_COLOR.x(), LIGHTNING_COLOR.y(), LIGHTNING_COLOR.z(), y, z, true, true, false, true);
                    HerobrineLightningEntityRenderer.drawBranch(matrix4f, vertexConsumer, p, q, r, s, t, LIGHTNING_COLOR.x(), LIGHTNING_COLOR.y(), LIGHTNING_COLOR.z(), y, z, false, true, false, false);
                }
            }
        }
    }
