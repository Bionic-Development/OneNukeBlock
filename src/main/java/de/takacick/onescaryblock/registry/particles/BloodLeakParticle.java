...
public class BloodLeakParticle
    ...
    public static class Factory
        ...
        public Particle createParticle(DefaultParticleType parameters, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            ContinuousFalling blockLeakParticle = new ContinuousFalling(clientWorld, d, e, f, Fluids.EMPTY, ParticleRegistry.BLOOD_SPLASH);
        ...
        protected void updateVelocity() {
            if (this.onGround) {
                ...
                if (this.random.nextDouble() <= 0.2) {
                    this.world.playSound(this.x, this.y, this.z,
                            ParticleRegistry.BLOOD_DROP, SoundCategory.BLOCKS, 0.2f, 1f, false);
                }
            }
        }
    }
