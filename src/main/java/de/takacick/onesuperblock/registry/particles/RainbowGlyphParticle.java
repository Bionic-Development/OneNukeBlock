...
public class RainbowGlyphParticle extends AscendingParticle {

    private int gameTime = 0;
    private boolean ignoreTime = false;

    protected RainbowGlyphParticle(ClientWorld world, int gameTime, boolean ignoreTime, double x, double y, double z, double velocityX, double velocityY, double velocityZ, float scaleMultiplier, SpriteProvider spriteProvider) {
    ...
    public static class Factory
        ...
        public Particle createParticle(RainbowParticleEffect particleEffect, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            return new RainbowGlyphParticle(clientWorld, particleEffect.offset(), particleEffect.ignoreTime(), d, e, f, g, h, i, 1.0f, this.spriteProvider);
        }
    }
}
