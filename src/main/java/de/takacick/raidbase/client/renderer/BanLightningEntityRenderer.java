...
public class BanLightningEntityRenderer
        extends EntityRenderer<LightningEntity> {
    public BanLightningEntityRenderer(EntityRendererFactory.Context context) {
        super(context);
    }
        ...
        for (int l = 0; l < 4; ++l) {
            ...
            for (int m = 0; m < 3; ++m) {
                ...
                for (int r = n; r >= o; --r) {
                    ...
                    drawBranch(matrix4f, vertexConsumer, p, q, r, s, t, 1.0f, 0.0f, 0.0f, y, z, false, false, true, false);
                    drawBranch(matrix4f, vertexConsumer, p, q, r, s, t, 1.0f, 0.0f, 0.0f, y, z, true, false, true, true);
                    drawBranch(matrix4f, vertexConsumer, p, q, r, s, t, 1.0f, 0.0f, 0.0f, y, z, true, true, false, true);
                    drawBranch(matrix4f, vertexConsumer, p, q, r, s, t, 1.0f, 0.0f, 0.0f, y, z, false, true, false, false);
                }
            }
        }
    }
