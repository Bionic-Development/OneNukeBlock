...
public class LaserDustParticle extends AnimatedParticle {

    LaserDustParticle(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, SpriteProvider spriteProvider) {
    ...
    public record Factory(SpriteProvider spriteProvider)
        ...
        public Particle createParticle(ColoredParticleEffect parameters, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            LaserDustParticle laserDustParticle = new LaserDustParticle(clientWorld, d, e, f, g, h, i, this.spriteProvider);
            laserDustParticle.setColor(parameters.color().x(), parameters.color().y(), parameters.color().z());
            return laserDustParticle;
        }
    }
}
