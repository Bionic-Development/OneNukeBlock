package de.takacick.secretcraftbase.client.shaders.vertex;
    ...
    public void quad(MatrixStack.Entry matrixEntry, BakedQuad quad, float[] brightnesses, float red, float green, float blue, int[] lights, int overlay, boolean useQuadColorData) {
        ...
        try {
            ...
            for (int k = 0; k < j; ++k) {
                ...
                this.vertexConsumer.vertex(vector4f.x(), vector4f.y(), vector4f.z(), o, p, q, this.alpha, m, n, overlay, r, vector3f.x(), vector3f.y(), vector3f.z());
            }
