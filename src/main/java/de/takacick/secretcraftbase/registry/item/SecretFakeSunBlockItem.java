...
public class SecretFakeSunBlockItem extends BlockItem {
    public SecretFakeSunBlockItem(Block block, Settings settings) {
    ...
    public ActionResult place(ItemPlacementContext context) {
        ...
        List<BlockPos> positions = getPositions(blockPos);
