...
public class SecretMagicWell extends AliasedBlockItem {

    public SecretMagicWell(Block block, Settings settings) {
    ...
    public ActionResult place(ItemPlacementContext context) {
        ...
        List<BlockPos> positions = getPositions(blockPos, blockState.get(SecretMagicWellBlock.FACING));
