...
public class SpitParticle
    ...
    SpitParticle(ClientWorld world, double x, double y, double z, Fluid fluid) {
        super(world, x, y, z);
    ...
    public int getBrightness(float tint) {
        return glowing ? 0xF000F0 : super.getBrightness(tint);
    }
    ...
    public static class Factory
        ...
        public Particle createParticle(DefaultParticleType parameters, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            ContinuousFalling blockLeakParticle = new ContinuousFalling(clientWorld,
                    d, e, f, Fluids.WATER, ParticleTypes.SPLASH);
