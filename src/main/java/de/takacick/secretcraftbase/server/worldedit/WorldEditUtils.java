package de.takacick.secretcraftbase.server.worldedit;
...
import de.takacick.secretcraftbase.server.utils.TimedCache;
...
public class WorldEditUtils {
    ...
    private static String URI = "assets/" + SecretCraftBase.MOD_ID + "/schematics";
    ...
    public static Optional<Clipboard> getClipboard(String schematic) {
        ...
        try {
            ...
            FileUtils.copyInputStreamToFile(SecretCraftBase.class.getClassLoader().getResourceAsStream(location + ".schem"), file);
