...
public class GrowParticle
    ...
    private GrowParticle(ClientWorld world, int owner, Vector3f color, double x, double y, double z, double velocityX, double velocityY, double velocityZ, SpriteProvider spriteProvider) {
        ...
        if (owner >= 0) {
            ...
            if (ownerEntity != null) {
                ...
                this.maxAge = (int) (Math.max( (float) (ownerEntity.getBodyY(1) - this.y), 0f) * 4f) + world.getRandom().nextInt(6);
    ...
    public static class Factory
        ...
        public Particle createParticle(ColoredParticleEffect particleEffect, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            return new GrowParticle(clientWorld, particleEffect.owner(), particleEffect.color(), d, e, f, g, h, i, this.spriteProvider);
        }
    }
}
