...
public class ItemRegistry {
    ...
    public static final Block GIANT_CRUSHER_TRAP = new GiantCrusherTrapBlock(AbstractBlock.Settings.create().mapColor(MapColor.BRIGHT_RED).requiresTool().strength(5.0f, 6.0f).dynamicBounds().pistonBehavior(PistonBehavior.BLOCK).sounds(BlockSoundGroup.METAL).solidBlock(Blocks::never).nonOpaque().solidBlock(Blocks::never).blockVision(Blocks::never));
