...
public class TinyBase extends Block {
    public static final DirectionProperty FACING = HorizontalFacingBlock.FACING;

    private static final VoxelShape BASE = VoxelShapes.cuboid(0.001, 0, 0.001, 0.9999, 1, 0.9999);

    public TinyBase(Settings settings) {
        super(settings);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        if (!world.isClient) {
            TinyBaseCommand.teleport(player);
        }
