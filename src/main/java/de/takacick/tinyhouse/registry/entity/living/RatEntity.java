package de.takacick.tinyhouse.registry.entity.living;
...
import de.takacick.tinyhouse.registry.entity.living.ai.RatPounceAtTargetGoal;
    ...
    public boolean tryAttack(Entity target) {
        ...
        if (bl && target instanceof LivingEntity livingEntity) {
            if (getWorld() instanceof ServerWorld serverWorld) {
                BionicUtils.sendEntityStatus(serverWorld, livingEntity, TinyHouse.IDENTIFIER, 2);
            }
