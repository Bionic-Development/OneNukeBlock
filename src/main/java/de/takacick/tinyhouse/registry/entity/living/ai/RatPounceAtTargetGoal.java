package de.takacick.tinyhouse.registry.entity.living.ai;
...
public class RatPounceAtTargetGoal
extends Goal {
    private final MobEntity mob;
    private LivingEntity target;
    private final float velocity;

    public RatPounceAtTargetGoal(MobEntity mob, float velocity) {
        this.mob = mob;
    ...
    public boolean canStart() {
        ...
        return this.mob.getRandom().nextInt(RatPounceAtTargetGoal.toGoalTicks(5)) == 0;
    }
