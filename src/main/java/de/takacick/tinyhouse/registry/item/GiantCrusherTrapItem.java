...
import de.takacick.tinyhouse.registry.block.GiantCrusherTrapBlock;
...
public class GiantCrusherTrapItem extends BlockItem {
    public GiantCrusherTrapItem(Block block, Settings settings) {
    ...
    public ActionResult place(ItemPlacementContext context) {
        ...
        List<BlockPos> positions = getPositions(blockPos.add(blockState.get(GiantCrusherTrapBlock.PLACE).getVector()));
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        ...
        tooltip.add(Text.of("§eCapable of §ccrushing ANYTHING§e!"));
