package de.takacick.tinyhouse.registry.statuseffects;
...
public class Bleeding extends StatusEffect {
    ...
    public void applyUpdateEffect(LivingEntity livingEntity, int amplifier) {
        if (!livingEntity.getWorld().isClient) {
            ...
            BionicUtils.sendEntityStatus((ServerWorld) livingEntity.getWorld(), livingEntity, TinyHouse.IDENTIFIER, 1);
        }
