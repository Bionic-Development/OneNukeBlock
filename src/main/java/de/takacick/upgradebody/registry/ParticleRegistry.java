...
import de.takacick.upgradebody.registry.particles.TargetParticleEffect;
...
public class ParticleRegistry {
    ...
    public static final SoundEvent VILLAGER_EXPLODE = SoundEvent.of(new Identifier(UpgradeBody.MOD_ID, "villager_explode"));

    public static void register() {
        Registry.register(Registries.PARTICLE_TYPE, new Identifier(UpgradeBody.MOD_ID, "dust"), DUST);
        Registry.register(Registries.PARTICLE_TYPE, new Identifier(UpgradeBody.MOD_ID, "totem_dust"), TOTEM_DUST);
        Registry.register(Registries.PARTICLE_TYPE, new Identifier(UpgradeBody.MOD_ID, "emerald_poof"), EMERALD_POOF);
        Registry.register(Registries.PARTICLE_TYPE, new Identifier(UpgradeBody.MOD_ID, "emerald_portal"), EMERALD_PORTAL);
        Registry.register(Registries.PARTICLE_TYPE, new Identifier(UpgradeBody.MOD_ID, "emerald_totem"), EMERALD_TOTEM);
        Registry.register(Registries.PARTICLE_TYPE, new Identifier(UpgradeBody.MOD_ID, "emerald_items"), EMERALD_ITEMS);
        Registry.register(Registries.PARTICLE_TYPE, new Identifier(UpgradeBody.MOD_ID, "emerald_explosion"), EMERALD_EXPLOSION);
        Registry.register(Registries.PARTICLE_TYPE, new Identifier(UpgradeBody.MOD_ID, "emerald_explosion_emitter"), EMERALD_EXPLOSION_EMITTER);
        Registry.register(Registries.PARTICLE_TYPE, new Identifier(UpgradeBody.MOD_ID, "emerald_spell"), EMERALD_SPELL);
