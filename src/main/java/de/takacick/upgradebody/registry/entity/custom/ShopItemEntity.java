...
public class ShopItemEntity extends Entity {
    ...
    private static final TrackedData<ItemStack> ITEM_STACK = BionicDataTracker.registerData(new Identifier(UpgradeBody.MOD_ID, "shop_item_stack"), TrackedDataHandlerRegistry.ITEM_STACK);
    private static final TrackedData<Integer> PRICE = BionicDataTracker.registerData(new Identifier(UpgradeBody.MOD_ID, "shop_item_price"), TrackedDataHandlerRegistry.INTEGER);
    private static final TrackedData<Float> OFFSET = BionicDataTracker.registerData(new Identifier(UpgradeBody.MOD_ID, "shop_item_offset"), TrackedDataHandlerRegistry.FLOAT);
    private static final TrackedData<Float> SCALE = BionicDataTracker.registerData(new Identifier(UpgradeBody.MOD_ID, "shop_item_scale"), TrackedDataHandlerRegistry.FLOAT);
