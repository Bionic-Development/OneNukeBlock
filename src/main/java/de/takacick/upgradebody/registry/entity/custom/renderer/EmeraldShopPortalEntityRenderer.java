...
import de.takacick.upgradebody.registry.entity.custom.model.EmeraldShopPortalEntityModel;
...
public class EmeraldShopPortalEntityRenderer extends EntityRenderer<EmeraldShopPortalEntity> {
    ...
    private static final Identifier TEXTURE = new Identifier(UpgradeBody.MOD_ID, "textures/entity/emerald_shop_portal.png");
    private static final SpriteIdentifier PORTAL = new SpriteIdentifier(SpriteAtlasTexture.BLOCK_ATLAS_TEXTURE, new Identifier(UpgradeBody.MOD_ID, "entity/emerald_portal"));
