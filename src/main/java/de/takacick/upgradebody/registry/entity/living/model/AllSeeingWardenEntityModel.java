...
public class AllSeeingWardenEntityModel<T extends WardenEntity>
    ...
    public AllSeeingWardenEntityModel(ModelPart root) {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData eye = body.addChild("eye", ModelPartBuilder.create().uv(5, 100).cuboid(-3.0F, -5.0F, -9.0F, 6.0F, 6.0F, 5.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
