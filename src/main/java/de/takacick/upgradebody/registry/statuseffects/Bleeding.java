package de.takacick.upgradebody.registry.statuseffects;
...
public class Bleeding extends StatusEffect {
    ...
    public void applyUpdateEffect(LivingEntity livingEntity, int amplifier) {
        if (!livingEntity.getWorld().isClient) {
            ...
            BionicUtils.sendEntityStatus((ServerWorld) livingEntity.getWorld(), livingEntity, UpgradeBody.IDENTIFIER, 4);
        }
